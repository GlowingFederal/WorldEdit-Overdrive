...
public final class OverdriveCommand extends CommandBase {
    ...
    private void status(ICommandSender sender){
        ...
        send(sender,"pastePlanningActive="+PasteHookStatus.pastePlanningActive.get()+" pasteCommitActive="+PasteHookStatus.pasteCommitActive.get()+" pasteSourceCellsVisited="+PasteHookStatus.pastePreparedBlocks.get()+" pasteSourceAirCells="+PasteHookStatus.pasteSourceAirCells.get()+" pasteIgnoreAirFilteredCells="+PasteHookStatus.pasteIgnoreAirFilteredCells.get());
        send(sender,"pasteDestinationMatchedCells="+PasteHookStatus.pasteDestinationMatchedCells.get()+" pasteOtherwiseFilteredCells="+PasteHookStatus.pasteOtherwiseFilteredCells.get()+" pastePlannedMutations="+PasteHookStatus.pastePlannedBlocks.get()+" pasteSubmittedMutations="+PasteHookStatus.pasteSubmittedBlocks.get()+" pasteCommittedMutations="+PasteHookStatus.pasteCommittedBlocks.get());
