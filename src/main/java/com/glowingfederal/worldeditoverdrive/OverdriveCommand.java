...
public final class OverdriveCommand extends CommandBase {
    ...
    private void status(ICommandSender sender){
        ...
        send(sender,"pastePreparedTiles="+PasteHookStatus.pastePreparedTiles.get()+" pasteCommittedTiles="+PasteHookStatus.pasteCommittedTiles.get()+" pastePreparedEntities="+PasteHookStatus.pastePreparedEntities.get()+" pasteCommittedEntities="+PasteHookStatus.pasteCommittedEntities.get()+" pasteTransformedBlocks="+PasteHookStatus.pasteTransformedBlocks.get());
        send(sender,"lastPasteTransform="+PasteHookStatus.lastPasteTransform+" lastPasteIgnoreAir="+PasteHookStatus.lastPasteIgnoreAir);
